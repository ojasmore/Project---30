...
function draw() {
  ...
  isTouching(box1,constraintobject);
  isTouching(box2,constraintobject);
  isTouching(box3,constraintobject);
  isTouching(box4,constraintobject);
  isTouching(box5,constraintobject);
  isTouching(box6,constraintobject);
  isTouching(box7,constraintobject);
  isTouching(box8,constraintobject);
  isTouching(box9,constraintobject);
  isTouching(box10,constraintobject);
  isTouching(box11,constraintobject);
  isTouching(box12,constraintobject);
  isTouching(box13,constraintobject);
  isTouching(box14,constraintobject);
  isTouching(box15,constraintobject);
...
function isTouching(lbox,lpolygon)
{
  ...
  if(distance<=lpolygon.radius + lbox.width/2 || distance<=lpolygon.radius + lbox.height/2){
    World.remove(lbox.body);
  }
}
